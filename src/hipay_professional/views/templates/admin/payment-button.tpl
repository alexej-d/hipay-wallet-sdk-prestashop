            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="radio t ">
                            <label><input type="radio" name="payment_form_type" id="payment_form_type_off" value="0" {if isset($config_hipay.payment_form_type) && !$config_hipay.payment_form_type} checked="checked"{/if}>{l s='iFrame (transparent payment form display)' mod='hipay_professional'}</label>
                        </div>
                        <p class="help-block">
            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="row">
                    <label class="control-label col-lg-2">
                        <span class="label-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title="{l s='Button text (French)' mod='hipay_professional'}">
                ...
                <div class="row">
                    <label class="control-label col-lg-2">
                        <span class="label-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title="{l s='Button text (English)' mod='hipay_professional'}">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <button type="button" class="btn btn-primary" id="add-image">{l s='Add a new payment button' mod='hipay_professional'}</button>
                    </div>
                </div>
                <div class="row">
                    <p class="help-block">
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <button type="submit" class="btn btn-default btn btn-default pull-right" name="submitPaymentbutton"><i class="process-icon-save"></i>{l s='Save configuration changes' mod='hipay_professional'}</button>
                    </div>
                </div>
            </div>
        </div>
