    ...
    <form method="post" action="{$smarty.server.REQUEST_URI|escape:'htmlall':'UTF-8'}" id="settings_form">
        <div class="row">
            <div class="col-md-12 col-xs-12">
                                    ...
                                    {else}
                                        ...
                                        {if !isset($config_hipay.production.$currency) || $config_hipay.production.$currency|@count == 0}
                                            ...
                                            {else}
                                                <td colspan="2">
                                                <span class="icon icon-warning-sign" aria-hidden="true">
                                                    <a href="javascript:void(0);" id="production_duplication_{$currency|escape:'htmlall':'UTF-8'}">{l s='Currency not activated. Click here to fix.' mod='hipay_professional'}</a>
                                                </span>
                                                </td>
                                            {/if}
                                        {else}
                ...
                <div class="row">
                    <div class="col-md-12 col-xs-12">
                        <button type="submit" class="btn btn-default pull-left" name="submitCancel"><i class="process-icon-eraser"></i>{l s='Discard changes' mod='hipay_professional'}</button>
                        <button type="submit" class="btn btn-default btn btn-default pull-right" name="submitSettings"><i class="process-icon-save"></i>{l s='Save configuration changes' mod='hipay_professional'}</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{l s='Close' mod='hipay_professional'}</button>
            </div>
        </div>
    </div>
</div>
