...
{if isset($validator) && $validator}
    <div class="panel">
        <form method="post" action="{$smarty.server.REQUEST_URI|escape:'htmlall':'UTF-8'}" id="validator_form">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <label class="control-label col-lg-2">
                                <span class="label-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title="{l s='Validation code' mod='hipay_professional'}">
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    <button type="submit" class="btn btn-default btn btn-default pull-right" name="submitValidator"><i class="process-icon-save"></i>{l s='Submit' mod='hipay_professional'}</button>
                </div>
            </div>
        </form>
    </div>
