...
class HipayProfessionnal extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('HiPay Professionnal');
        $this->description = $this->l('Accept payments by credit card and other local methods with HiPay Professionnal. Very competitive rates, no configuration required!');
    ...
    public function installHipay()
    {
        ...
        return (_PS_VERSION_ >= '1.7') ? $return17 : $return16;
    }
